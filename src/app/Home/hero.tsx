  ...
  return (
    <div className="bg-gray-50">
      ...
      >
        ...
        >
          <p className="py-1 w-32 border-black border-[1px] flex items-center text-center justify-center rounded-full">Why Need it</p>
          <h1 className="pt-2 lg:text-[52px] md:text-[28px]">
      ...
      >
        {partners.map((partner, index) => (
          <div
            key={index}
            className="font-bold text-white/[100] text-[18px] leading-7 items-center justify-center flex h-14 bg-[#535c47a3] border-[0.2px] border-white backdrop-blur-[8px]"
          >
            {partner}
          </div>
        ))}
